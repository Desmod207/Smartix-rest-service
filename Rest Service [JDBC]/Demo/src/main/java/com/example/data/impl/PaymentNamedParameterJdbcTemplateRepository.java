...
@Repository
public class PaymentNamedParameterJdbcTemplateRepository implements PaymentRepository {
    ...
    public PaymentNamedParameterJdbcTemplateRepository(NamedParameterJdbcTemplate jdbcTemplate) {
